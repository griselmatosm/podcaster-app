...
test('renders podcast details correctly', () => {
  ...
  expect(screen.getByText('This is a sample podcast description.')).toBeInTheDocument();
  expect(screen.getByAltText('Sample Podcast')).toHaveAttribute('src', 'sample-image.jpg');
})